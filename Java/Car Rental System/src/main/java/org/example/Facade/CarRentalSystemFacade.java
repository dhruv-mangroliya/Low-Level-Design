...
public class CarRentalSystemFacade {
    public static void startCarRentalSystem(CarRentalSystemBackend carRentalSystemBackend){
        ...
        Vehicle vehicle1 = VehicleFactory.createVehicle("GJ-05-AZ-001", 1000, CarType.FOUR_SEATER_COMPACT);
        Vehicle vehicle2 = VehicleFactory.createVehicle("GJ-06-FY-324", 2000, CarType.FOUR_SEATER_XUV);
        Vehicle vehicle3 = VehicleFactory.createVehicle("GJ-14-IZ-781", 10000, CarType.LUXURY);
